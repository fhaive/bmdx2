...
info_panel = function(id, style = "sample"){
  bsCollapsePanel(id, style=style,
                  fluidRow(
                    HTML(" <a style=color:blue;  target=\"_blank\"; href=\"https://github.com/fhaive/bmdx2\">GitHub</a>")
                  ),
                  fluidRow(
                  ...
                  fluidRow(
                    HTML("<a style=color:blue;  target=\"_blank\"; href=\"https://github.com/fhaive/bmdx2/blob/main/bleomycin_data/phenodata_all_timepoints.xlsx\">Sample pheno data</a>")
                  ),
                  fluidRow(
                    HTML("<a style=color:blue;  target=\"_blank\"; href=\"https://github.com/fhaive/bmdx2/blob/main/bleomycin_data/vst_counts_all_timepoints.xlsx\">Sample expression data</a>")
                  ),
                  fluidRow(
                    HTML("<a style=color:blue;  target=\"_blank\"; href=\"https://github.com/fhaive/bmdx2/blob/main/bleomycin_data/gene_profiled.xlsx\">Sample background</a>")
                  )
  )
}
